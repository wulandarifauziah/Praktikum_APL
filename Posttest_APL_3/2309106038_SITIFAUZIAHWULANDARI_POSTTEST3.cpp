...
void ubah()
{
    ...
    if (x >= 1 && x <= awal)
    {
        ...
        if (loop == "y")
            ubah(); // Rekursi jika pengguna ingin mengubah data lagi
    }
    else
    {
        cout << "Index tidak valid. Masukkan index antara 1 dan " << awal << endl;
        ubah(); // Rekursi untuk meminta input indeks lagi
    }
}
...
void hapus()
{
    ...
    if (x >= 1 && x <= awal)
    {
        ...
        if (loop == "y")
            hapus(); // Rekursi jika pengguna ingin menghapus data lagi
    }
    else
    {
        cout << "Indeks tidak valid. Masukkan indeks antara 1 dan " << awal << endl;
        hapus(); // Rekursi untuk meminta input indeks lagi
    }
}
